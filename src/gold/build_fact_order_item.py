...
# Paths
ORDER_ITEMS_PATH = "/opt/airflow/data/silver/orderItems/orderItems.parquet"
ORDERS_PATH = "/opt/airflow/data/silver/orders/orders.parquet"
CUSTOMERS_PATH = "/opt/airflow/data/gold/dimensions/dim_customers.parquet"   
PRODUCTS_PATH = "/opt/airflow/data/gold/dimensions/dim_products.parquet"
DATE_PATH = "/opt/airflow/data/gold/dimensions/dim_date.parquet"
FX_PATH = "/opt/airflow/data/silver/exchange_rates/exchange_rates.parquet"

GOLD_PATH = "/opt/airflow/data/gold/facts/fact_order_items.parquet"
